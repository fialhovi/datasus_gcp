...
class SIHController:
  ...
  def request_multiple_RD_reports_dbc_format(params: List[Tuple[str, str, str]]) -> None:
    """
  ...
  def request_RD_report_dataframe_format(uf: str, year: str, month: str) -> pd.DataFrame:
    """
  ...
  def dbc_to_parquet(dbc_files_directory: str = "./data/dbc") -> List:
    ...
    for file in files:
      try:
        ...
        output_path = os.path.join(output_directory, os.path.basename(parquet_file))
